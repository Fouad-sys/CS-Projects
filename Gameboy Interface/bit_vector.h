...
/**
 * #brief Enum of extract types.
 */
 typedef enum {ZERO, WRAP} extract_type;
 
/**
 * @brief 32-bits vector with only ones
 */
#define VECTOR_32_ONES ((uint32_t)4294967295)
 
/**
 * @brief 32-bits vector with only zeros
 */
#define VECTOR_32_ZEROS ((uint32_t)0)
