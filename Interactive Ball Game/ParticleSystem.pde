...
class ParticleSystem { 
  ...
  boolean checkPosition(PVector otherCenter) {
    boolean isInsideBoard = otherCenter.x + CYLINDER_BASE_SIZE < gameSurface.width/2 + milestone3.PLATE_SIZE && 
                            otherCenter.x - CYLINDER_BASE_SIZE > gameSurface.width/2 - milestone3.PLATE_SIZE && 
                            otherCenter.y + CYLINDER_BASE_SIZE < gameSurface.height/2 +milestone3.PLATE_SIZE&& 
                            otherCenter.y - CYLINDER_BASE_SIZE > gameSurface.height/2 - milestone3.PLATE_SIZE;
